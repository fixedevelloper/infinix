...
var countDownDate = new Date("Dec 12, 2023 00:00:00").getTime();
...
/*    document.getElementById("progressTimer").innerHTML = days + "d " + hours + "h "
        + minutes + "m " + seconds + "s ";*/
    document.getElementById("p_day").innerHTML=days;
    document.getElementById("p_hour").innerHTML=hours;
    document.getElementById("p_min").innerHTML=minutes;
    document.getElementById("p_sec").innerHTML=seconds;
    // If the count down is finished, write some text
    if (distance < 0) {
        clearInterval(x);
        document.getElementById("p_sec").innerHTML = "EXPIRED";
    }
}, 1000);

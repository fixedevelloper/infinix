...
@section('content')
    ...
    <div class="contact padding-top padding-bottom">
                              ...
                              {{--  <div class="contact__item" data-aos="fade-right" data-aos-duration="1000">
                                    <div class="contact__item-inner">
                                        <div class="contact__item-thumb">
                                            <span><img src="{{asset('images/phone-dark.png')}}" alt="contact-icon" class="dark"></span>
                                        </div>
                                ...
                                <div class="contact__item" data-aos="fade-right" data-aos-duration="1100">
                                    <div class="contact__item-inner">
                                        <div class="contact__item-thumb">
                                            <span><img src="{{asset('images/envelope-dark.png')}}" alt="contact-icon" class="dark"></span>
                                        </div>
                                        <div class="contact__item-content">
                                            <p>
                                                Bitrader@gmail.com
                                ...
                                <div class="contact__item" data-aos="fade-right" data-aos-duration="1200">
                                    <div class="contact__item-inner">
                                        <div class="contact__item-thumb">
                                            <span><img src="{{asset('images/marer-dark.png')}}" alt="contact-icon" class="dark"></span>
                                        </div>
                                        <div class="contact__item-content">
                                            <p>
                                                88 Sheridan Street
      ...
      <span class="contact__shape-item contact__shape-item--1"><img src="{{asset('images/contact_shap04.png')}}"
                                                                    alt="shape-icon"></span>
